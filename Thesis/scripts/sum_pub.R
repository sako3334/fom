...
plot(xaxt='n', yaxt='n', x = pub_all[, "years"], y = pub_all[, "records"], xlab = "Veröffentlichungsjahr", ylab = "Summe Publikationen", type = "n", xlim = c(2010,2019), ylim = c(500,2000))
axis(side = 1, xaxp=c(2010, 2017, 7))
axis(side = 2, yaxp=c(500, 2000, 10))
