...
Für die Analyse der Leitfragen ist es wichtig, eine Übersicht über die vorliegenden Daten zu erhalten. Anschließend werden die Daten des \glqq Hype Cycles\grqq~mit denen der Suchergebnisse aus den wissenschaftlichen Datenbanken für jede Technologie einzeln miteinander verglichen. Dazu ist es zum einen wichtig, den vergangenen Trendverlauf der Technologien sowie mögliche Zukunftsszenarien festzustellen. Zum anderen ist darauf aufbauend eine Klassifizierung der Technologien vorzunehmen, um die Qualität der Analyse zu erhöhen.

\subsubsection{TODO Gartner}
Die aus dem \glqq Gartner Hype Cycle for Emerging Technology\grqq~ermittelten Daten bieten eine Reihe von Informationen über die Entwicklung einer Technologie über die Zeit.

Die Position in einem einzelnen Diagramm gibt Aufschluss darüber, wie hoch die Erwartungen der Wirtschaftsunternehmen an die Technologie sind und welche zeitliche Entfernung bis zur Marktreife vorliegt. Wird diese Information mit der Verteilung über alle Ausgaben kombiniert, sind weitere Schlüsse, wie die Geschwindigkeit der Entwicklung in Richtung Marktreife oder ein potentiell vorzeitiges Ausscheiden aus der Trendkurve möglich.

Auf Basis dieser Erkenntnis werden den Technologien weitere Attribute, wie  zugeordnet und klassifiziert.

Für eine bessere Übersicht des Verlaufes werden die Technologien in einem Kurvendiagramm abgebildet, um eine Gegenüberstellung hinsichtlich Gemeinsamkeiten und Unterschieden besser erkennen zu können. Dazu werden die Gewichtungsfaktoren, Phase und Position in geeignete Koeffizienten überführt, um so einen stetigen Trendverlauf abbilden zu können. Hierbei ist es umso vorteilhafter, je häufiger die Technologie in vergangenen bzw. späteren Ausgaben vorhanden ist. Jedoch kurzlebige Trends.

Letzte Ausgabe folgende Technologien herausgefallen
GCD, MDC
