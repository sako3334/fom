...
Der erweiterte Suchmodus bietet in allen Suchmaschinen die Möglichkeit, Suchanfragen mittels Kommandoanweisungen einzugeben. Die Operatoren zur Verknüpfung von Suchbegriffen sind nahezu identisch, wobei die Syntax einer Suchanweisung teilweise unterschiedlich ist. Somit sind die Querys untereinander nicht beliebig austauschbar. Im IEEE können einige Suchkriterien, wie z.B. Publikationsart oder Veröffentlichungsjahr nicht per Kommando eingegeben werden und müssen durch entsprechende Auswahl von Bedienelementen in der Weboberfläche erfolgen.

Im ersten Schritt werden die Technologien aus Abschnitt \ref{sec:ghcet} unverändert in die Suchmaschine eingegeben, um eine Übersicht der Datenlage zu erhalten. Mit den oben genannten Eingrenzungen ergibt das für den Begriff \glqq Machine Learning\grqq~folgende Suchalgorithmen je Suchmaschine:

\begin{description}
	\item [WoS:] \begin{verbatim}
	(TS=("machine learning")) AND DOCUMENT TYPES:
	...
	\begin{itemize}
		...
		\item Content Types: Conferences, Journals \& Magazines
	\end{itemize}
