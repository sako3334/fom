...
\begin{table}
	...
	\hline
	Technologien & AV & SR, CH & MDC, ML, SDS & GCD, B, CEA, NE, SDx \\
	\end{tabularx}
	\caption*{Quelle: Eigene Darstellung}
\end{table}

Für die Beantwortung der Leitfrage L3 werden die Technologien benötigt, die nach Erscheinen in einer Ausgabe des \glqq Hype Cycle\grqq~im Folgejahr weggefallen sind. Die Technologien und das Jahr der Absenz werden in Tabelle \ref{tab:ghc_abscence}
